...
./build/tools/caffe train \
    -solver data/flowers/model/SLPDA_alexnet_KD_from_imagenet/v2_SLPDA_alexnet_KD_from_imagenet_solver.prototxt \
    ...
    -gpu $GPUID 2>&1 | tee data/flowers/model/SLPDA_alexnet_KD_from_imagenet/flowers_v2_SLPDA_alexnet_KD_from_imagenet_log.txt
